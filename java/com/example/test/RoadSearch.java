...
public class RoadSearch extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Log.e("마커의 ID : ", "" + markerItem1.getTMapPoint());
            }
        });
        ...
        tmapview.setOnClickListenerCallBack(new TMapView.OnClickListenerCallback() {
            ...
            public boolean onPressEvent(ArrayList<TMapMarkerItem> arrayList, ArrayList<TMapPOIItem> arrayList1, TMapPoint tMapPoint, PointF pointF) {
                if (!arrayList.isEmpty()) {
                    Log.e("마커의 ID : ", "" + arrayList.get(0).getTMapPoint());
    ...
    public void markerSave(TMapView tmapview, ArrayList poiItem, int i) {
        ...
        Log.d("POI Name: ", item.getPOIName().toString() + ", " +
                ...
                "Point: " + item.getPOIPoint().toString() + ", " + i);
    ...
    public void onLocationChange(Location location) {
        if (location != null) {
            ...
            Log.d("현재위치1", "" + tMapPointMy.toString());
    ...
    public void locationParsing() {
        ...
        for (int i = 0; i < par.size(); i++)
            Log.d("지정 위치", Double.toString(par.get(i).getLatitude()) + Double.toString(par.get(i).getLongitude()));
        ...
        public void run() {
            ...
            try {
                ...
                if(poiItem.isEmpty()) {
                    ...
                    Log.d("search start point : ", Double.toString(startPoint.getLatitude()) + " " + Double.toString(startPoint.getLongitude()));
    ...
    class ThreadEndPoint extends Thread {
        ...
        public void run() {
            try {
                Log.d("e n d : ", Double.toString(endPoint.getLatitude()) + Double.toString(endPoint.getLongitude()));
                Log.d("start : ", Double.toString(startPoint.getLatitude()) + Double.toString(startPoint.getLongitude()));
